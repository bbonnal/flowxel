...
public class ConstructLineLineIntersectionOperation(ResourcePool pool, Graph<IExecutableNode> graph) : ExecutionNode<Line, Point>(pool, graph)
{
        ...
        CancellationToken ct)
    {
        ...
        return new Point
        {
            ...
            LineWeight = inputs[0].LineWeight,
            Fill = inputs[0].Fill
        };
    }

...
public class CombineNode<TIn, TOut>(CombineOperation<TIn, TOut> operation, ResourcePool pool, Graph<IExecutableNode> graph) : IExecutableNode where TOut : notnull
{
